...
public class __HugeRte extends CustomField<String>
     ...
     */
    public __HugeRte(String label, String initialValue) {
        this();
        setLabel(label);
     ...
     */
    public __HugeRte(String label, String initialValue, ValueChangeListener<? super ComponentValueChangeEvent<CustomField<String>, String>> valueChangeListener) {
        this();
        setLabel(label);
        setValue(initialValue);
     ...
     * @param valueChangeListener value change listener
     */
    public __HugeRte(String label, ValueChangeListener<? super ComponentValueChangeEvent<CustomField<String>, String>> valueChangeListener) {
        this();
        setLabel(label);
        addValueChangeListener(valueChangeListener);
    }
     ...
     * @param valueChangeListener value change listener
     */
    public __HugeRte(ValueChangeListener<? super ComponentValueChangeEvent<CustomField<String>, String>> valueChangeListener) {
        this();
        addValueChangeListener(valueChangeListener);
    }
    ...
    public __HugeRte configure(String configurationKey, String value) {
        checkAlreadyInitialized();
    ...
    public __HugeRte configure(String configurationKey, boolean value) {
        checkAlreadyInitialized();
        config.put(configurationKey, value);
        return this;
    }

    public __HugeRte configure(String configurationKey, double value) {
        checkAlreadyInitialized();
        config.put(configurationKey, value);
        return this;
    }

    public __HugeRte configureLanguage(Language language) {
    ...
    private __HugeRte initBasicEditorConfiguration() {
        setValue("");
    ...
    public __HugeRte configurePlugins(Plugin... plugins) {
        return configurePlugins(false, plugins);
    }

    public __HugeRte configurePlugins(boolean setupBasicConfig, Plugin... plugins) {
        checkAlreadyInitialized();
    ...
    public __HugeRte configureMenubar(Menubar... menubars) {
        return configureMenubar(false, menubars);
    }

    public __HugeRte configureMenubar(boolean setupBasicConfig, Menubar... menubars) {
        checkAlreadyInitialized();
    ...
    public __HugeRte configureToolbar(Toolbar... toolbars) {
        return configureToolbar(false, toolbars);
    }

    public __HugeRte configureToolbar(boolean setupBasicConfig, Toolbar... toolbars) {
        checkAlreadyInitialized();
     ...
     */
    public __HugeRte configureResize(ResizeDirection direction) {
